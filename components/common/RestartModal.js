...
export default function RestartModal({ displayRestartModal, setDisplayRestartModal }) {

    const navigation = useNavigation();

    const handleRestartSession = async () => {
        await setDisplayRestartModal(false);
            ...
            <View style={styles.centeredView}>
                <View style={[styles.container, {blurRadius: 9, backgroundColor: "white", width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center'}]}>
                    <View style={[styles.container, {backgroundColor: "black", width: '90%', height: 300, padding: 20}]}>
                                <Text style={styles.title}>RECOMMENCER LA SEANCE</Text>
                                <Text style={styles.text}>
                                    ES-TU CERTAIN DE VOULOIR RECOMMENCER LA SEANCE ? 
                            ...
                            <View style={styles.buttonContainer}>
                                ...
                                <TouchableOpacity
                                    ...
                                    >
                                    <Text style={styles.leaveText}>RECOMMENCER</Text>
                                </TouchableOpacity>
                            </View>
                    </View>
                </View>
